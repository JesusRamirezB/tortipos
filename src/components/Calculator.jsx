...
function Calculator({ tortillaProduct, calculatorValue, setCalculatorValue, calculatorMode, setCalculatorMode, onAdd, onCancel }) {
        ...
        <div className="calculator-fullscreen">
            <div className="calculator-top">
                <div className="calculator-header">
                    <button className="back-btn" onClick={onCancel}>← Regresar</button>
                ...
                <div className="calculator-main">
                    <div className="calculator-display-box">
                        ...
                        <div className="display-main mono">
                            {calculatorMode === 'pesos' ? '$' : ''}{getDisplayText()}{calculatorMode === 'kg' ? ' kg' : ''}
                        </div>
                    ...
                    <div className="calculator-numpad">
                        ...
                        <button className="num-btn special" onClick={() => handleNumberClick('.')}>.</button>
                        <button className="num-btn" onClick={() => handleNumberClick('0')}>0</button>
                        <button className="num-btn special" onClick={handleBackspace}>⌫</button>
                    </div>
                </div>
